...
in :mod:`aisimulate.sdk.picking` (``get_pareto_front``) for plotting.
...
:mod:`aisimulate.sdk.picking` works without change.
"""
...
from aisimulate.legacy_cli.deprecation import deprecated_sweeper_entry_point
...
from aisimulate.sdk.picking import parallel_dim, worker_gpus
...
# the same values as :data:`aisimulate.sdk.picking._RATE_MATCHING_*`
...
def sweep_agg(
    *,
    ...
    ``aisimulate.sdk.picking`` (used for plotting only — config selection
...
def sweep_disagg(
    *,
    ...
    if autoscale:
        from aisimulate.sdk.picking import pick_autoscale
