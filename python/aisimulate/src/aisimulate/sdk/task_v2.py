...
- ``sweep_agg_kwargs()`` / ``sweep_disagg_kwargs()`` build the exact
  kwargs needed by :mod:`aisimulate.sdk.sweep` — no caller
  marshalling required.

See ``src/aisimulate/legacy_cli/example.yaml`` for the canonical YAML format.
"""
...
from aisimulate.sdk.operations.moe_comm import MOE_A2A_BACKENDS, nodes_for
...
class Task:
    ...
    dispatches to :mod:`aisimulate.sdk.sweep` -- callers don't need to
    ...
    def _context_fmha_supported_modes(self, role: str, ctx_op: str | None = None) -> list[str]:
        ...
        from aisimulate.sdk.perf_database import context_fmha_supported_modes
    ...
    def _attention_quant_identity_mixed(self, role: str) -> bool:
        ...
        from aisimulate_core.sdk.models.helpers import attention_projection_exclusions
    ...
    def build_speculative_profile(self) -> SpeculativeDecodingProfile:
        ...
        if spec_config is not None:
            from aisimulate.sdk.speculation import build_spec_scheme
    ...
    def validate(self) -> None:
        ...
        if self.enable_epd:
            ...
            if self.encoder_batch_candidates:
                from aisimulate.sdk.sweep import _MAX_ENCODER_BATCH
    ...
    def _validate_sglang_wideep_attention_backend(self) -> None:
        ...
        for role in roles:
            ...
            if ("wideep_context_mla", "wideep_generation_mla") not in self._reachable_attention_op_keys(role):
                continue
            from aisimulate.sdk.errors import UnsupportedAttentionBackendError
    ...
    def _check_role_against_db(
        ...
        *,
        ...
        from aisimulate.sdk.operations import moe as moe_ops
    ...
    def _overlay_single_point_encoder(
        ...
        *,
        ...
        from aisimulate.sdk.sweep import _get_encoder_worker_candidates, _overlay_encoder_stage
    ...
    def run_single_agg(
        ...
        *,
        ...
        from aisimulate.sdk.predict import predict_agg_worker
    ...
    def run_single_disagg(
        ...
        *,
        ...
        from aisimulate.sdk.backends.factory import get_backend
        from aisimulate.sdk.models import get_model
        from aisimulate.sdk.predict import predict_disagg_worker
