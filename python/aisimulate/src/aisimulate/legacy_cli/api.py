...
from aisimulate.sdk.config import ModelConfig, has_video_input
from aisimulate.sdk.config_builders import apply_nextn as _apply_nextn
from aisimulate.sdk.config_builders import build_model_config as _build_model_config
from aisimulate.sdk.config_builders import resolve_dspark_nextn as _resolve_dspark_nextn
from aisimulate.sdk.config_builders import resolve_nextn_auto as _resolve_nextn_auto
from aisimulate.sdk.errors import ExperimentOutcome, NoFeasibleConfigError, is_gpu_retriable
...
from aisimulate.sdk.moe_comm_resolver import resolve_model_config_moe_comm
from aisimulate.sdk.performance_result import MoECommFallback, merge_moe_comm_fallbacks
from aisimulate.sdk.rust_engine_step import validate_engine_step_backend
from aisimulate.sdk.speculative import (
...
def cli_support(
    ...
    *,
    ...
    """
    from aisimulate.sdk.common import check_support
...
def cli_estimate(
    ...
    *,
    ...
    if speculative is not None:
        from aisimulate.sdk.speculative import resolve_speculative_block
...
def _run_static_estimate(
    *,
    ...
    whose ``raw`` dict follows :data:`aisimulate.sdk.common.ColumnsStatic`.
    """
    from aisimulate.sdk.config import RuntimeConfig
    from aisimulate.sdk.inference_session import InferenceSession
...
def _run_disagg_estimate(
    *,
    ...
    from aisimulate.sdk.config import RuntimeConfig
    from aisimulate.sdk.inference_session import DisaggInferenceSession
...
from aisimulate.generator.api import generate_naive_config as cli_generate
