...
from aisimulate.legacy_cli.estimate_detail_report import (
    detail_requests_time,
    format_estimate_detail_report,
    format_moe_comm_fallback,
)
from aisimulate.legacy_cli.report_and_save import log_final_summary, save_results
from aisimulate.legacy_cli.utils import merge_experiment_results_by_mode, process_experiment_result
from aisimulate.logging_utils import setup_logging
from aisimulate.sdk import common, perf_database
from aisimulate.sdk.attention_lanes import ATTENTION_BACKEND_CHOICES
from aisimulate.sdk.config_builders import resolve_nextn_auto
...
def _run_estimate_epd(args, estimate_mode: str) -> None:
    ...
    from aisimulate.legacy_cli.api import apply_row_power_coverage_gate
    from aisimulate.sdk.task_v2 import _QUANT_ENUM_TABLES, Task
...
def _run_recommend(args) -> None:
    ...
    from aisimulate.sdk.errors import NoResultsError
