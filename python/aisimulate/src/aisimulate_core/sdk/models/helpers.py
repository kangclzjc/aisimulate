...
def build_large_ep_moe_ops(
    ...
    *,
    ...
    from aisimulate_core.sdk.models.blocks.moe import build_moe_block_ops
...
def resolve_dsv4_moe_arch_mode(
    ...
    if not _is_dsv4_fp4_expert_model(model_path):
        return None
    from aisimulate_core.sdk.perf_database import is_blackwell_system, is_hopper_system
...
def resolve_kimi_k3_moe_arch_mode(
    ...
    if model_path != "moonshotai/Kimi-K3":
        return None
    from aisimulate_core.sdk.perf_database import is_blackwell_system
...
def resolve_context_fmha_by_data(
    ...
    * fmha auto-inferred to fp8 with no fp8 slice but a bf16 one: downgrade
    ...
    from aisimulate_core.sdk.perf_database import context_fmha_supported_modes
